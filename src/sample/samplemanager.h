...
public:
    ...
    void SetPlateMetadata(std::string plate_id, std::string key, nlohmann::ordered_json value);

    void SetWellsEnabled(std::string plate_id, std::vector<std::string> well_ids, bool enabled=true);
    void SetWellsMetadata(std::string plate_id, std::vector<std::string> well_ids, std::string key, nlohmann::ordered_json value);
    
    void CreateSitesOnCenteredGrid(std::string plate_id, std::vector<std::string> well_ids,
    ...
    ::Site *Site(std::string plate_id, std::string well_id, std::string site_id);
