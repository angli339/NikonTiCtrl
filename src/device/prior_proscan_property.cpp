...
std::unordered_map<std::string, std::string> errorCodeProScan = {
    {"E,1", "NO STAGE"},
    {"E,2", "NOT IDLE"},
    {"E,3", "NO DRIVE"},
    {"E,4", "STRING PARSE"},
...
std::unordered_map<std::string, PropInfoProScan> propInfoProScan = {
    {"MotionStatus", {
        .name        = "Motion Status",
        .description = "Reports status as a decimal number and gives motion status of any axis of the controller. After binary conversion convention is as follows:\n"
                       "  F2  F1  A   Z   Y   X\n"
    ...
    {"StopMotion", {
         .name = "Stop motion",
         .description = "Stops movement in a controlled manner to reduce the risk of losing position",
         .getCommand  = "",
         .setCommand = "I",
         .setResponse = "R",
         .isVolatile  = false,
    ...
    {"RawXYPosition", {
        ...
        .description = "Position of stage (x, y) in the unit of XY",
        .getCommand  = "PS",
        .setCommand  = "G,{}",
        .setResponse = "R",
        .isVolatile  = true,
...
//        .isVolatile  = false,
//    }},
    {"LumenShutter", { // Turn on/off shutter with the actual "Lumen Output Intensity" command.
        .name        = "Lumen Shutter",
        .description = "",
        .getCommand  = "LIGHT",
        .setCommand  = "LIGHT,{}",
    ...
    {"LumenOutputIntensity", { // We actually keep the number and only issue I/O when LumenShutter is set.
...
//    }},
    ...
    {"Baudrate", {
        .name        = "Baudrate",
        .description = "The baud rate of the port (write-only). As a protection measure, if no command is sent to the port while the controller is switched on, the baud rate will revert to 9600 after switching off and back on again twice. Allowable values for baud rate are 9600 (argument 96), 19200 (argument 19) and 38400 (argument 38)",
        .getCommand  = "",
        .setCommand  = "BAUD,{}",
        .setResponse = "", // It actual has response, but it is unclear what it is.
        .isVolatile  = false,
    }},
    {"CommandProtocol", {
        .name        = "Command Protocol",
        .description = "Command protocol (Compatibility mode (1) or Standard mode (0)).",
        .getCommand  = "COMP",
        .setCommand  = "COMP,{}",
        .setResponse = "0",
        .isVolatile  = false,
    ...
    {"SerialNumber", {
        .name        = "Serial Number",
        .description = "Reports the units’ serial number nnnnn, if the serial number has not been set “00000” is returned.",
        .getCommand  = "SERIAL",
        .setCommand  = "",
        .setResponse = "",
        .isVolatile  = false,
    ...
    {"Stage_SCurveValue", {
        ...
        .description = "Stage S-curve value is the rate of change of acceleration during the transition from stationary until the stage reaches the full acceleration. Range is 1 to 100.",
        .getCommand  = "SCS",
        .setCommand  = "SCS,{}",
        .setResponse = "0",
        .isVolatile  = false,
